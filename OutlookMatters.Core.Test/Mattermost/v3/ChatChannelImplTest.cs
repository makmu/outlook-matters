...
namespace Test.OutlookMatters.Core.Mattermost.v3
{
    ...
    public class ChatChannelImplTest
    {
        ...
        public void CreatePost_UsesRestServiceToCreatePost()
        {
            ...
            var sut = new ChatChannelImpl(restService.Object, baseUri, TOKEN, TEAM_GUID, channel);
        ...
        public void ToSetting_ReturnsChannelId()
        {
            ...
            var sut = new ChatChannelImpl(Mock.Of<IRestService>(), baseUri, TOKEN, TEAM_GUID, channel);
